...
We are excited to announce the start of our BBSRC- “Bioinformatics and Biological Resources Fund” grant to help build n[ext generation agri-ecology workflows and their respective communities](https://shorturl.at/bjAI3).

We are a team of ecologists (<a href="{{ site.baseurl }}/the-group/seirian-sumner/" data-type="page" data-id="12">Seirian Sumner</a>), bioinformaticians ([Yannick Wurm](https://shorturl.at/ABQV7)), [Chris Wyatt](https://shorturl.at/fkAF1) and pipeline developers ([Seqera](https://seqera.io/)). Our aim is to develop bioinformatics resources to ease the bottleneck of bioinformaticians in the agri-ecological research community.
...
<img src="{{ site.baseurl }}/wp-content/uploads/2023/11/image-1.png" class="wp-image-1830 size-full" loading="lazy" decoding="async" srcset="{{ site.baseurl }}/wp-content/uploads/2023/11/image-1.png 251w, {{ site.baseurl }}/wp-content/uploads/2023/11/image-1-131x300.png 131w" sizes="auto, (max-width: 251px) 100vw, 251px" width="251" height="573" />
</figure>
